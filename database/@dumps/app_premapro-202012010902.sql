...
CREATE TABLE `feeds`  (
  ...
  `long_end_mark` timestamp(0) NULL DEFAULT NULL,
  `short` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `short_end_mark` timestamp(0) NULL DEFAULT NULL,
  `any_start_mark` timestamp(0) NULL DEFAULT NULL,
...
-- Records of feeds
-- ----------------------------
INSERT INTO `feeds` VALUES (1, 1, '', NULL, 'https://biz-cen.ru/spam/feed_demo.php', '2020-12-04 14:23:56', '2020-12-04 14:23:55', '2020-11-30 21:52:15', '2020-12-04 14:23:44');
...
CREATE TABLE `offers`  (
  ...
  `cleaning_included` tinyint(1) NULL DEFAULT NULL COMMENT 'Клининг входит в договор аренды (bool)',
  `utilities_included` tinyint(1) NULL DEFAULT NULL COMMENT 'Коммунальные услуги включены (bool)',
  `electricity_included` tinyint(1) NULL DEFAULT NULL COMMENT 'Электроэнергия включена (bool)',
  ...
  `adding_phone_on_request` tinyint(1) NULL DEFAULT NULL COMMENT 'Возможность добавления телефонных линий (bool)',
  `internet` tinyint(1) NULL DEFAULT NULL COMMENT 'Наличие интернета (bool)',
  `self_selection_telecom` tinyint(1) NULL DEFAULT NULL COMMENT 'Возможность выбора оператора (bool)',
  `room_furniture` tinyint(1) NULL DEFAULT NULL COMMENT ' \r\nНаличие мебели (bool)',
  `air_conditioner` tinyint(1) NULL DEFAULT NULL COMMENT 'Наличие системы кондиционирования (bool)',
  `ventilation` tinyint(1) NULL DEFAULT NULL COMMENT 'Наличие вентиляции (bool)',
  `fire_alarm` tinyint(1) NULL DEFAULT NULL COMMENT 'Наличие пожарной сигнализации (bool)',
  `water_supply` tinyint(1) NULL DEFAULT NULL COMMENT 'Наличие водопровода (bool)',
  `sewerage_supply` tinyint(1) NULL DEFAULT NULL COMMENT 'Наличие канализации (bool)',
  `electricity_supply` tinyint(1) NULL DEFAULT NULL COMMENT 'Наличие электроснабжения (bool)',
  `electric_capacity` int(10) NULL DEFAULT NULL COMMENT 'Выделенная электрическая мощность',
  `gas_supply` tinyint(1) NULL DEFAULT NULL COMMENT 'Подключение к газовым сетям (bool)',
  ...
  `heating_supply` tinyint(1) NULL DEFAULT NULL COMMENT 'Наличие отопления (bool)',
  ...
  `guarded_building` tinyint(1) NULL DEFAULT NULL COMMENT 'Закрытая территория (bool)',
  `access_control_system` tinyint(1) NULL DEFAULT NULL COMMENT 'Наличие пропускной системы (bool)',
  `twenty_four_seven` tinyint(1) NULL DEFAULT NULL COMMENT 'Круглосуточный доступ 7 дней в неделю (bool)',
...
-- Records of roles
-- ----------------------------
INSERT INTO `roles` VALUES (1, 'admin', 'Administrator', 'Site administrator', 0, '2020-11-29 22:12:59', '2020-11-29 22:13:02');
INSERT INTO `roles` VALUES (2, 'guest', 'Guest', 'Unverified user', 1, '2020-11-29 22:13:04', '2020-11-29 22:13:07');
...
-- Records of teams
-- ----------------------------
INSERT INTO `teams` VALUES (1, 1, 'Test Company', NULL, 1, '2020-11-29 23:09:32', '2020-11-29 23:09:32');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 'admin@admin.com', 'admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 'Active', '2020-11-29 23:09:32', NULL, '2020-11-29 22:13:22', '2020-11-29 22:13:25');
