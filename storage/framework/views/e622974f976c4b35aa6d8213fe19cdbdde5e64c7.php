...
<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <table>
        ...
        <?php if(isset($params['main']['address'])): ?>
            <tr>
                <td class="row-cell column">
                    <div class="row-title">
        ...
        <?php endif; ?>
        <?php if(isset($params['main']['description'])): ?>
            <tr>
                <td class="row-cell column">
                    <div class="row-title">
        ...
        <?php endif; ?>
        <?php if(isset($params['general']['storeys'])): ?>
            <tr>
                <td class="row-cell column">
                    <div class="row-title">
        ...
        <?php endif; ?>
        <?php if(isset($params['technical']['lift'])): ?>
            <tr>
                <td class="row-cell column">
                    <div class="row-title">
        ...
        <?php endif; ?>
        <?php if(isset($params['technical']['units_count'])): ?>
            <tr>
                <td class="row-cell column">
                    <div class="row-title">
...
<?php /**PATH C:\xampp\htdocs\prema\resources\views/exports/templates/current.blade.php ENDPATH**/ ?>