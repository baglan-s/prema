...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?> 
                    <div class="p-0 mb-4 exports-panel js-exports-panel <?php echo e($team->has_choise ? 'd-block' : 'd-none'); ?>">
                        <p class="py-2 mb-0 export-notice">...</p>
                    ...
                    <div class="overflow-auto">
                        <table class=" offers-table js-offers-table delivery" data-action="<?php echo e(route('offers.select-offer')); ?>">
                            <thead>
                            <tr>
                                <th scope="col">&#10004;</th>
                            ...
                            <?php $__currentLoopData = $offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="js-offer-row" id="offer<?php echo e($item->id); ?>">
                                    ...
                                    <td data-label="Entire"><?php echo e($item->rent_entire ? 'yes' : 'no'); ?></td>
                                </tr>
...
<?php echo $__env->make('layouts.custom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\prema\resources\views/custom/offers/index.blade.php ENDPATH**/ ?>