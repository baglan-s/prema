<p class="mb-0">Use the filters below to refine your search...
    <?php if(request()->route()->getName() == 'offers.filtered' and (strlen(implode($requestData)) > 0)): ?>
        <?php ($btnCaption = 'Showing all results...'); ?>
        <span class="ml-3"><a href="<?php echo e(route('offers.index', $teamId)); ?>">Reset All Filters</a></span>
    <?php endif; ?>
</p>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 mb-3">
                    <div class="custom-control custom-switch mt-1 ml-md-2">
                        ...
                        >
                        <label class="custom-control-label" for="withPropertys">With propertys</label>
                    </div>
                </div>
                <div class="col-xl-4 mb-3">
                    <div class="custom-control custom-switch mt-1 ml-md-2">
                        ...
                        >
                        <label class="custom-control-label" for="rentEntire">Rent the entire property</label>
                    </div>
                </div>
            </div>
            <div class="row">
...
</form><?php /**PATH /var/www/sites/prema/resources/views/components/filters/search-filter.blade.php ENDPATH**/ ?>