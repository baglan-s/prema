...
<?php endif; ?> 
                    ...
                    <?php if(count($teams) && auth()->user()->isAdmin()): ?>
                        <hr>
...
<?php echo $__env->make('layouts.custom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\prema\resources\views/teams-index.blade.php ENDPATH**/ ?>