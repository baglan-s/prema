...
<head>
    ...
    <link media="screen" rel="stylesheet" href="{{ url('exports/templates/css/7.css?v=').time() }}">
...
<div class="content">
    ...
    <div class="header">
        <div class="header-wrap">
            <div class="header-company-info width-45 dinline-block">
                <h1>{{ $offer->name }}</h1>
                <div class="company-info">
                    @if (isset($params['main']['address']) && !empty($params['main']['address']))
                        <span>{{ $offer->location['city'] }}, {{ $offer->location['address'] }}</span>
                    @endif
                        ...
                        @endif
                    <span>Расстояние до метро — 5 минут</span>
                </div>
            </div>
            <div class="header-owner-info width-52 dinline-block">
                <div class="header-logo">logo</div>
                <div class="owner-info">
                    <span>Связаться с нами:</span>
                    <span>Phone: +7 123 456 7899</span>
                    <span>www.ourrealestate.com</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="pictures-block width-41 dinline-block">
        <div class="main-image first m-b-20 image-block" style="background-image: url({{ asset('exports/images/offers/cover.jpg') }})"></div>
    ...
    <div class="content-block width-58 dinline-block">
        <div class="main">
            ...
            <b class="list-block-subtitle">Вакантные офисные помещения (м²):</b>
            <table class="pr-table width-100">
                <thead>
                    <tr>
                        <th>Этаж</th>
                        <th>Площадь</th>
